...
def writeMeter(self, openetran):
    ...
    writeWidgets(openetran, grid, 'meter', 2, 4, 1)
...
def writeResistor(self, openetran):
    ...
    writeWidgets(openetran, grid, 'resistor', 1, 4, 1)
...
def writeCapacitor(self, openetran):
    ...
    writeWidgets(openetran, grid, 'capacitor', 1, 4, 1)
...
def writeInductor(self, openetran):
    ...
    writeWidgets(openetran, grid, 'inductor', 1, 4, 0)
...
def writeCustomer(self, openetran):
    ...
    writeWidgets(openetran, grid, 'customer', 5, 6, 0)
...
def writePipegap(self, openetran):
    ...
    writeWidgets(openetran, grid, 'pipegap', 1, 4, 0)